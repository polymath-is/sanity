  ...
  render(): JSX.Element {
    ...
    return (
      <div
        ...
        // So the toolbar doesn't interfere when dragging in fullscreen mode. TODO: solve this more gracefully!
        style={{pointerEvents: PortableTextEditor.isDragging(editor) ? 'none' : 'unset'}}
      >
